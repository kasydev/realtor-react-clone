...
const EditListing = () => {
  ...
  const params = useParams();
   ...
   }, [auth.currentUser, navigate, listing]);
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <button
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium rounded transition duration-300 ease-in-out uppercase text-sm shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg  "
          type="submit"
        >
          Edit Listing
        </button>
